...
class SceneAggregator:
    ...
    def _compute_two_frame_comfort(self, current_token: str, previous_token: str) -> float:
        ...
        # # TODO commented code is to replace the assertion leading to failure which crashes the evaluation when some scene fail, with returning a "fail" score for comfort
        # if not (0 < observation_interval < 0.55):
        #     return 0.0 # return zero comfort for invalid intervals
