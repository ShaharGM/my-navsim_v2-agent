...
from navsim.agents.dp_copy.dp_config import DPConfig
...
class DPModel(nn.Module):
    def __init__(self, config: DPConfig):
        ...
        backbone_ckpt_path="/sci/labs/sagieb/dawndude/projects/navsim_workspace/navsim/models/gtrs_dp.ckpt"
    ...
    def train(self, mode=True):
        ...
        if mode:
            ...
            # (Add any other frozen components here if needed)
    ...
    def forward(self, features: Dict[str, torch.Tensor],
        ...
        selected_traj = torch.zeros(batch_size, 8, 3)
