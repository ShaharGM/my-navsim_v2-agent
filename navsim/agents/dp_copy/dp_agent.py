...
from navsim.agents.dp_copy.dp_model import DPModel
from navsim.agents.dp_copy.dp_callback import DPCallbacks
...
class DPAgent(AbstractAgent):
    ...
    def get_training_callbacks(self) -> List[pl.Callback]:
        ...
        return [
            ckpt_callback,
            DPCallbacks(config=self._config, num_samples=5)
        ]
