...
class TransfuserConfig:
    ...
    plan_anchor_path: str = "/sci/labs/sagieb/dawndude/projects/DiffusionDrive/models/utils/kmeans_navsim_traj_20.npy"
    bkb_path: str = "/sci/labs/sagieb/dawndude/projects/DiffusionDrive/models/utils/resnet34.a1_in1k"
