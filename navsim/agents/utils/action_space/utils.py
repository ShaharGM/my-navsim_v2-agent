...
def construct_DTD(
    ...
    device: torch.device = torch.device("cpu"),
    dtype: torch.dtype = torch.float32,
    w_smooth1: Union[float, torch.Tensor, None] = None,
    w_smooth2: Union[float, torch.Tensor, None] = None,
    w_smooth3: Union[float, torch.Tensor, None] = None,
    lam: float = 1e-3,
    dt: float = 1.0,
) -> torch.Tensor:
...
def solve_single_constraint(
    ...
    w_data: Union[torch.Tensor, None] = None,
    w_smooth1: Union[float, torch.Tensor, None] = None,
    w_smooth2: Union[float, torch.Tensor, None] = None,
    w_smooth3: Union[float, torch.Tensor, None] = None,
    lam: float = 1e-3,
