...
class Scene:
    ...
    def get_all_ego_statuses(self) -> List[EgoStatus]:
        return [frame.ego_status for frame in self.frames]

    def get_history_ego_statuses(self) -> List[EgoStatus]:
        return self.get_all_ego_statuses()[:self.scene_metadata.num_history_frames]

    def get_future_ego_statuses(self) -> List[EgoStatus]:
        return self.get_all_ego_statuses()[self.scene_metadata.num_history_frames:]
