...
torchrun --nproc_per_node=$NUM_GPUS --master_port=$MASTER_PORT \
        ...
        trainer.resume_ckpt_path="${NAVSIM_EXP_ROOT}/training_action_dp_agent/2026.03.03.16.14.22/lightning_logs/version_29511323/checkpoints/epoch_074-val_loss_1.0229.ckpt"